...
PROVIDER_CONFIGS = {
    ...
    "opencode":   {"env": "OPENCODE_API_KEY",     "lib": "openai",     "base": os.getenv("OPENCODE_HOST","https://opencode.ai/zen")+"/v1", "default_model": os.getenv("OPENCODE_MODEL", "claude-sonnet-4"), "description": "OpenCode Zen gateway — frontier models via one key (opencode.ai/zen)"},
